...
public class KnownDefects {
	...
	public static void main(String[] args) {
				...
				//checking for Known Defects Page
				driver.findElement(By.xpath("/html/body/table[2]/tbody/tr[1]/td[3]/table/tbody/tr[4]/td/a")).click();
				System.out.println("you are in Known defects page");
	}
